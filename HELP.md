...
* The original package name 'com.servicios tienda web.servicios tienda web' is invalid and this project uses 'com.servicios.tienda.web.servicios.tienda.web' instead.
